...
//	
	...
	public void user_clicks_on_income() {
		objBDA.IncomeField();
	   System.out.println("Uswer clicks the income");
	}
	...
	public void user_needs_to_provide_the_and_and_and_and(String name , String Invoicenumber, String amount, String date, String description) {
	...
	public void user_clicks_on_expenses() {
		objBDA.Finances();
		objBDA.expenses();
		System.out.println("user click the Finance and choose the Expenses");
	}
	...
	public void user_needs_to_enters_the_and_and_and_and(String string, String string2, String string3, String string4, String string5) {
